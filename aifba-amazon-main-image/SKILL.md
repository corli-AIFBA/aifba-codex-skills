---
name: aifba-amazon-main-image
description: Use when the user wants AIFBA to generate optimized Amazon main images from an Amazon.com product URL or ASIN in Codex. Calls the AIFBA Skills API, waits for the server-side task, downloads and extracts the generated image files, and returns image briefs, local image paths, report URL, and status.
---
...
python scripts/run_skill.py --product-url "https://www.amazon.com/dp/B0XXXXXXXX" \
  --competitor-url "https://www.amazon.com/dp/B0YYYYYYYY"
```
